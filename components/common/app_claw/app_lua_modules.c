...
#endif
#if CONFIG_APP_CLAW_LUA_MODULE_EMOTION
...
#if CONFIG_APP_CLAW_LUA_MODULE_EMOTION
static esp_err_t app_lua_register_emotion(const char *fatfs_base_path)
{
    (void)fatfs_base_path;
    return emotion_video_register_lua();
}
#endif
...
#endif
#if CONFIG_APP_CLAW_LUA_MODULE_EMOTION
    { "emotion", "Emotion", app_lua_register_emotion },
#endif
#if CONFIG_APP_CLAW_LUA_MODULE_DISPLAY
