...
> ⚠️ **本文档由知识图谱自动生成**，分析时间: 2026-05-31 | Commit: `ad85396`
> 
> 自动生成内容可能存在不准确或过时之处。以下为项目的**权威参考文档**，建议优先阅读：
> - [ARCHITECTURE_CN.md](../ARCHITECTURE_CN.md) — 最全面的中文架构手册
> - [CLAUDE.md](../../../CLAUDE.md) — 面向 LLM 助手的项目指南（含构建命令、架构摘要、关键文件索引）
> - [硬件显示架构.md](../硬件显示架构.md) — 显示系统架构（含 display_arbiter 深度分析）
> - [情绪切换系统架构文档.md](../情绪切换系统架构文档.md) — 情绪视频切换系统
> - [Web管理界面架构文档.md](../Web管理界面架构文档.md) — 前端管理界面架构
