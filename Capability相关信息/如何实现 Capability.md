...
本节介绍如何为 AIRI 编写一个自定义 Capability，完整地覆盖从文件结构、描述符定义到 Group 注册的全流程。
...
└── skills/
    └── cap_my_feature/
        └── SKILL.md              # Skill 元数据与正文（可选，见下文文档）
```
...
> **可选，但建议**：虽然 Capability 的 Skills 激活方式是可选的，但建议为每个 Capability 提供配套的 Skills 文档。
>
